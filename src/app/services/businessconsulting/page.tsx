    ...
    <>
      ...
      <div className="container mx-auto flex items-center justify-around w-3/4 mt-16">
        <h1 className="text-white pb-4 ">
          Our Business Consulting Services address a companys end-to-end
      ...
      <div className=" container mx-auto w-3/4 mb-16 text-white">
        ...
        <p className="mb-4">
          ...
          that address a companys end-to-end business needs. We aim to support
        ...
        <p>
          ...
          activities and safeguarding the wealth and health of the clients
          organization.
        </p>
      </div>
